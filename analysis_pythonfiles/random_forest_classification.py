...
plt.savefig("randomForest_classif_all_features_vtx_var.png", dpi=300, bbox_inchex="tight")
plt.close()
...
plt.savefig("randomForest_classif_all_features_group_pairs_var.png", dpi=300, bbox_inchex="tight")
plt.close()
