...
use_data = data_sets[ds[2][0]]
use_behav = data_sets[ds[2][1]]
rocs = np.zeros(100)
...
while idx < 100:
    ...
    try:
        res_alt, roc_alt, res_null, roc_null = rf_feature_selector(
...
alt_rdata = extract_from_dict(global_results, "alt", use_data.columns.values, 100, 51)
...
plt.savefig("adults_adols_rochist_rffeatselect_100iters.png", bbox_inches="tight", dpi=300)
plt.close()

# save results as pickle files
save_pkl_name = "feat_counts_and_imps_adadol_rffeatselect_100iters.pkl"
