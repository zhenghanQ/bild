...
t1vol = 42.0
t2vol = 50.0
path='/om/project/bild/Analysis/task_openfmri/first_level/output_dir_071616/model01/task001/'
...
pfa2df.to_csv('lessthan20%motiontask1.csv', index=None)
pfa3df.to_csv('lessthan30%motiontask1.csv', index=None)
